...
int* getNearlyColor(__global int *palette,int colorCount,int r,int g,int b) {
...
__kernel void dither(__global int *colors,__global int *palette,__global *settings,__global int *result) {
